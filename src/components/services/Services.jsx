    ...
    <div className="services__content">
        ...
        <div className={toggleState === 1 ? "services__modal active-modal" : "services__modal"}>
            <div className="services__modal-content">
                ...
                <p className="services__modal-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A sunt ab illum distinctio praesentium itaque.</p>

                <ul className="services__modal-services grid">
                    <li className="services__modal-service">
                        <i className="uil uil-check-circle servces__modal-icon"></i>
                    ...
                    <li className="services__modal-service">
                        <i className="uil uil-check-circle servces__modal-icon"></i>
                        <p className="services__modal-info">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas, hic?.</p>
                    </li>
